...
export const GridImage = ({ image, editable, className, ...rest }: GridImageProps) => {
  return (
  ...
  return (
    <section className={`${props.params.styles} py-20 max-md:space-y-8`} id={id}>
      <div className="container space-y-4 text-center">
        <p className="eyebrow">
          <Text field={Eyebrow} editable={editable} />
        </p>
        <h2>
          <Text field={Heading} editable={editable} />
        </h2>
      </div>
      ...
      <div className="grid items-center gap-2 **:gap-2 md:grid-cols-[5fr_2fr] md:gap-4 md:**:gap-4 lg:grid-cols-[5fr_2fr_5fr]">
        <div className="grid">
          <div className="grid grid-cols-[3fr_5fr] items-end">
            <GridImage image={Image1} editable={editable} className="aspect-5/7" />
            <GridImage image={Image2} editable={editable} className="aspect-13/9" />
          </div>
          <div className="grid grid-cols-[10fr_9fr] lg:items-start">
            <GridImage image={Image3} editable={editable} className="aspect-6/5" />
            <GridImage image={Image4} editable={editable} className="aspect-auto lg:aspect-10/7" />
          </div>
        </div>
        ...
        <GridImage
          image={Image5}
          editable={editable}
          className="aspect-2/1 md:aspect-3/4 md:max-lg:self-end"
        />

        <div className="grid gap-4 md:max-lg:col-span-2">
          <div className="grid grid-cols-[2fr_3fr] lg:items-end">
            <GridImage image={Image6} editable={editable} className="aspect-auto lg:aspect-5/6" />
            <GridImage image={Image7} editable={editable} className="aspect-1/1" />
          </div>
          <div className="grid grid-cols-[2fr_3fr_3fr] items-start">
            <GridImage image={Image8} editable={editable} className="aspect-11/15" />
            <GridImage image={Image9} editable={editable} className="aspect-4/3" />
          </div>
        </div>
      </div>
    </section>
